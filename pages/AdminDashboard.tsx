...
const AdminDashboard: React.FC = () => {
  const { auth, products, addProduct, removeProduct } = useApp();
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-12">
          ...
          <div className="flex gap-3">
            <button 
              ...
              className="bg-brand text-white px-6 py-2 rounded-box text-xs font-bold uppercase tracking-widest hover:bg-brand-hover transition-colors flex items-center gap-2"
            >
        ...
        <div className="grid grid-cols-1 gap-8">
          <div className="space-y-8">
            {/* Product Management */}
            <div className="bg-white rounded-box border border-stone-100 shadow-sm overflow-hidden">
              <div className="p-6 border-b border-stone-100 flex items-center justify-between">
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="pl-8 pr-4 py-1.5 bg-stone-50 border border-stone-200 rounded-box text-[10px] outline-none focus:border-brand transition-all w-48"
                  />
                </div>
              </div>
                      ...
                      <tr key={product.id} className="hover:bg-stone-50 transition-colors">
                        <td className="px-6 py-4">
                          <div className="flex items-center gap-3">
                            <img src={product.image} alt={product.name} className="w-10 h-10 rounded-box object-cover border border-stone-100" referrerPolicy="no-referrer" />
                            <div>
        ...
        {isAddModalOpen && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <motion.div 
              ...
              className="relative w-full max-w-2xl bg-white rounded-box shadow-2xl overflow-hidden"
            >
              <div className="p-6 border-b border-stone-100 flex items-center justify-between">
              ...
              <form onSubmit={handleAddProduct} className="p-8 space-y-6 max-h-[70vh] overflow-y-auto">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input 
                        ...
                        className="w-full px-4 py-2.5 bg-stone-50 border border-stone-200 rounded-box text-sm outline-none focus:border-brand transition-all"
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input 
                          ...
                          className="w-full pl-10 pr-4 py-2.5 bg-stone-50 border border-stone-200 rounded-box text-sm outline-none focus:border-brand transition-all"
                    ...
                    <div>
                      ...
                      <textarea 
                        ...
                        className="w-full px-4 py-2.5 bg-stone-50 border border-stone-200 rounded-box text-sm outline-none focus:border-brand transition-all resize-none"
                ...
                <div className="pt-6 border-t border-stone-100 flex justify-end gap-4">
                  <button 
                    type="button"
                    onClick={() => setIsAddModalOpen(false)}
                    className="px-6 py-2.5 rounded-box text-xs font-bold uppercase tracking-widest text-stone-400 hover:text-stone-600 transition-colors"
                  >
                    Cancel
                  </button>
                  <button 
                    type="submit"
                    className="bg-brand text-white px-8 py-2.5 rounded-box text-xs font-bold uppercase tracking-widest hover:bg-brand-hover transition-colors shadow-lg shadow-brand/20"
                  >
                    Create Product
                  </button>
                </div>
